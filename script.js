...
function openAttachmentViewer(id) {
  ...
  document.getElementById('attachment-path').innerText =
    path;
    ...
    <div class="drawer-body">
      ...
      <div class="attachment-list">
        ...
        ${
          isRadio
            ? `
              <div class="attachment-item" onclick="openAttachmentViewer('radio-score')"><span class="label">圖形記譜</span></div>
              <div class="attachment-item" onclick="openAttachmentViewer('radio-instrument')"><span class="label">樂器演示</span></div>
              <div class="attachment-item" onclick="openAttachmentViewer('radio-film')"><span class="label">廢墟園林錄像</span></div>
            `
            : `
              <div class="attachment-item" onclick="openAttachmentViewer('plague-scan')"><span class="label">圖形記譜</span></div>
              <div class="attachment-item" onclick="openAttachmentViewer('plague-audio')"><span class="label">樂器演示</span></div>
              <div class="attachment-item" onclick="openAttachmentViewer('plague-film')"><span class="label">廢墟園林錄像</span></div>
            `
        }
...
const closeBtn = document.querySelector('.attachment-close');

if (closeBtn) {
  closeBtn.addEventListener('click', closeAttachmentViewer);
}

document.addEventListener('click', (e) => {
  if (e.target.classList.contains('attachment-close')) {
...
document.addEventListener('DOMContentLoaded', () => {
  const btn = document.querySelector('.attachment-close');

  if (btn) {
    btn.addEventListener('click', closeAttachmentViewer);
  }
});
/* =========================
   viewer outside click close
========================= */
